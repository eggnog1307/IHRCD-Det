# IHRCD-Det: A High-Resolution Detection Dataset for Reinforced Concrete Surface Defects of Industrial Architectural Heritage
...
---
## ✍️ Citation
If you use IHRCD-Det in your research, please cite our paper:


```bibtex
@article{xiao2026ihrcd,
  title = {IHRCD-Det: A high-resolution detection dataset for reinforced concrete surface defects of industrial architectural heritage},
